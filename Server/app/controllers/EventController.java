...
public class EventController {
    ...
    public Result addEvent() {
        ...
        if (type.equals("WorkEvent")) {
            int locationId = Util.createLocation(session, jsonNode.get("location").get("city").asText(), jsonNode.get("location").get("province").asText(), jsonNode.get("location").get("country").asText());
